...
`;function z({storage:d,configurableFeatures:h}){let p={navContainers:["nav.lfe-body","nav.sidebar","nav.lside"],navText:".text, .title"},x=new Map(h.map(t=>[t.storageKey,t.label]));function k(){if(document.getElementById("luogusp-style"))return;let t=document.createElement("style");t.id="luogusp-style",t.textContent=y,(document.head||document.documentElement).appendChild(t)}let c=new Set,S=()=>{for(let t of[...c])t()};function E(){if(document.getElementById("luogusp-settings"))return;let t=document.createElement("div");t.id="luogusp-settings",t.innerHTML=`
          ...
          <div class="luogusp-list">
            ${[...x].map(([u,o])=>`
              <label class="luogusp-item">
                <input type="checkbox" data-key="${u}" ${d.get(u)?"checked":""}>
                <span>${o}</span>
              </label>`).join("")}
          </div>
      ...
      </div>`,document.body.appendChild(t);let e=()=>t.querySelectorAll('input[type="checkbox"]'),s=!1;function l(u){u.key==="Escape"&&i()}let i=()=>{s||(s=!0,t.remove(),document.removeEventListener("keydown",l),c.delete(i))};c.add(i),t.addEventListener("click",u=>{let o=u.target;if(o.classList.contains("luogusp-mask"))return i();let n=o.getAttribute&&o.getAttribute("data-act");if(n==="close")return i();n==="all"&&e().forEach(r=>r.checked=!0),n==="none"&&e().forEach(r=>r.checked=!1),n==="save"&&(e().forEach(r=>d.set(r.dataset.key,r.checked)),i(),w())}),document.addEventListener("keydown",l)}function w(){let t=document.createElement("div");t.id="luogusp-settings",t.innerHTML='<div class="luogusp-mask"></div><div class="luogusp-panel" role="alertdialog" aria-modal="true"><div class="luogusp-content"><h3>设置已保存</h3><p class="luogusp-confirm">是否立即刷新页面生效？</p><div class="luogusp-actions"><button data-act="reload" class="luogusp-primary">立即刷新</button><button data-act="later">稍后</button></div></div></div>',document.body.appendChild(t);let e=!1,s=o=>{e||(e=!0,t.remove(),document.removeEventListener("keydown",i),c.delete(l),o&&location.reload())},l=()=>s(!1);c.add(l);function i(o){o.key==="Escape"&&s(!1),o.key==="Enter"&&s(!0)}t.addEventListener("click",o=>{let n=o.target;if(n.classList.contains("luogusp-mask"))return s(!1);let r=n.getAttribute&&n.getAttribute("data-act");if(r==="reload")return s(!0);if(r==="later")return s(!1)}),document.addEventListener("keydown",i);let u=t.querySelector('[data-act="reload"]');u&&u.focus()}let A="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58c.18-.14.23-.41.12-.61l-1.92-3.32c-.12-.22-.37-.29-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54c-.04-.24-.24-.41-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58c-.18.14-.23.41-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z";function g(t){for(t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("fill","currentColor");t.firstChild;)t.removeChild(t.firstChild);let e=document.createElementNS("http://www.w3.org/2000/svg","path");return e.setAttribute("d",A),t.appendChild(e),t}function L(t){let e=document.createElementNS("http://www.w3.org/2000/svg","svg");return t&&t.getAttribute("class")?e.setAttribute("class",t.getAttribute("class")):(e.style.width="1.1em",e.style.height="1.1em",e.style.marginRight=".4em",e.style.verticalAlign="middle"),g(e)}let f=t=>t.querySelector(p.navText);function m(){let t=null,e=null;for(let a of p.navContainers){let v=document.querySelector(a);if(v){t=v,e=a;break}}if(!t||t.querySelector(".luogusp-setting-entry"))return;let s=[...t.querySelectorAll("a")].filter(a=>a.querySelector("svg, img, .icon")&&f(a));if(!s.length)return;let l=s[s.length-1],i=l.closest("li"),u=i&&t.contains(i)?i:l,o=u.cloneNode(!0),n=o.matches("a")?o:o.querySelector("a");if(!n)return;n.removeAttribute("href"),n.removeAttribute("id"),n.classList.remove("router-link-active","router-link-exact-active","active"),n.classList.add("luogusp-setting-entry"),n.setAttribute("role","button");let r=f(n);r&&(e==="nav.lfe-body"?(r.textContent="",r.append("插件",document.createElement("br"),"设置")):r.textContent="插件设置");let b=n.querySelector("svg");if(b)g(b);else{let a=n.querySelector("img, i");a&&a.replaceWith(L(a))}n.addEventListener("click",a=>{a.preventDefault(),a.stopPropagation(),E()}),u.parentNode.insertBefore(o,u.nextSibling)}function C(){let t=null,e=()=>{t=null;try{m()}catch(l){console.error("LuoguSP setting entry:",l)}},s=new MutationObserver(()=>{t===null&&(t=requestAnimationFrame(e))});return s.observe(document.body,{childList:!0,subtree:!0}),m(),()=>{s.disconnect(),t!==null&&cancelAnimationFrame(t),document.querySelectorAll(".luogusp-setting-entry").forEach(l=>(l.closest("li")||l).remove()),S()}}return Object.freeze({id:"settings",mount:()=>(k(),C())})}export{z as createSettingsFeature};
